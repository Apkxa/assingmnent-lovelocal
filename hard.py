...
<script type="text/javascript">
    ...
    <meta name="description" content="Easily execute Python 3 code online with our user-friendly Python 3 compiler (interpreter). Our interpreter uses the latest version of the standard Python 3 interpreter to ensure accurate results. Try our Python 3 online compiler now!">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<meta http-equiv="Content-type" content="text/html; charset=UTF-8">  
    	<title id="pageTitle">Python3 Online Compiler - GeeksforGeeks</title>

	<link rel="icon" href="https://ide.geeksforgeeks.org/images/gfglogo.ico" type="image/x-icon">
	<link href="hard_files/icon.css" rel="stylesheet"> 
        <link href="hard_files/css.css" rel="stylesheet"> 
	<link href="hard_files/font-awesome.min.css" rel="stylesheet">
	<link rel="stylesheet" href="hard_files/bootstrap.min.css">
	<link rel="stylesheet" href="hard_files/gfg-style.css">
	<link rel="stylesheet" type="text/css" href="hard_files/cookieconsent.min.css">
	<link rel="stylesheet" href="hard_files/header-footer.css">

	<script src="hard_files/jquery.min.js"></script>
	<script defer="defer" src="hard_files/bootstrap.min.js"></script>
	<script src="hard_files/clipboard.min.js"></script>
	<script type="text/javascript">
	...
	<script defer="defer" src="hard_files/ace.js"></script>
	<script defer="defer" src="hard_files/ext-themelist.js"></script>
	<script defer="defer" src="hard_files/ext-language_tools.js"></script>
    <script src="hard_files/beautify-html.min.js"></script>
	<script defer="defer" src="hard_files/gfg-main.js"></script>
	<script async="" src="hard_files/gfg-header-footer.js"></script>
	<!--[if lt IE 9]>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.2/html5shiv.min.js" type="text/javascript"></script>
		<script src="https://cdnjs.cloudflare.com/ajax/libs/respond.js/1.4.2/respond.min.js" type="text/javascript"></script>
	<![endif]-->
	<script async="async" src="hard_files/f_002.txt"></script>
	<script>
		var googletag = googletag || {};
		googletag.cmd = googletag.cmd || [];
	</script>
<script async="" src="hard_files/optimize.js"></script>	

        <script src="hard_files/cookieconsent.min.js"></script>
        <script>
...
understood our <a href="https://www.geeksforgeeks.org/cookie-policy/" class="cc-link" target="_blank">Cookie Policy</a> &amp;  <a aria-label="learn more about cookies" role="button" tabindex="0" class="cc-link" href="https://www.geeksforgeeks.org/privacy-policy/" target="_blank">Privacy Policy</a></span><div class="cc-compliance"><a aria-label="dismiss cookie message" role="button" tabindex="0" class="cc-btn cc-dismiss">Got it!</a></div><!--googleon: all--></div><div id="g_id_onload" data-client_id="388036620207-3uolk1hv6ta7p3r9l6s3bobifh086qe1.apps.googleusercontent.com" data-login_uri="https://auth.geeksforgeeks.org/oauth/google.php"  data-state_cookie_domain="geeksforgeeks.org" data-redirect="https://ide.geeksforgeeks.org/online-python3-compiler" data-cancel_on_tap_outside="false"></div>
    ...
    <div class="header-main__wrapper stick-me">
        ...
        <div class="header-main__container">
            <h1 style="font-size:18px" id="pageHeading" class="header-main__right">Python3 Online Compiler</h1>
            ...
            <ul class="header-main__left-list" data-type="0" data-nl="false">
                    ...
                    <a type="button" class="header-main__signup login-modal-btn" href="https://auth.geeksforgeeks.org/?to=https%3A%2F%2Fide.geeksforgeeks.org%2Fonline-python3-compiler">Sign In</a>
                </li>
                            </ul>
        </div>
        ...
        <div class="header-sidebar__wrapper">
            <ul class="header-sidebar__list">
                                <li class="header-sidebar__list-item"><a href="https://auth.geeksforgeeks.org/?to=https%3A%2F%2Fide.geeksforgeeks.org%2Fonline-python3-compiler" class="gfg-sec-bg color-white login-modal-btn" style="color: white!important; text-align: center; padding : 10px!important;" target="_self">Sign In</a>
                </li>
...
<link rel="stylesheet" href="hard_files/font-awesome.min_002.css">
<link rel="stylesheet" href="hard_files/bootstrap-social.css">
<script src="hard_files/api.js" async="" defer="defer"></script>
<script src="hard_files/platform.js" gapi_processed="true"></script>
<link rel="stylesheet" href="hard_files/css_002.css">
<link rel="stylesheet" href="hard_files/icon.css">
<script src="hard_files/typeahead.bundle.js"></script> 
<style>
  *,
  *:after,
  *:before{
...
<script src="hard_files/dropzone.js"></script>	
<script type="text/javascript">
var language = 'Python3';</script>
<style>
    .fullScreen {
      position: relative;
    }
		...
		<div class="col-sm-9 col-xs-12 normalScreen">
		    <div class="mainleftDiv">
				...
				<div class="row form-group btn-group vertBtns" role="group">
					<a href="https://ide.geeksforgeeks.org/online-c-compiler" target="_blank" l="C" class="lang btn btn-default form-control" style="border-radius: 0;">C</a>
					<a href="https://ide.geeksforgeeks.org/online-cpp-compiler" target="_blank" data-toggle="tooltip" title="C++11 supported" l="Cpp" class="lang btn btn-default form-control">C++</a>
					<a href="https://ide.geeksforgeeks.org/online-cpp14-compiler" target="_blank" l="Cpp14" class="lang btn btn-default form-control">C++14</a>
					<a href="https://ide.geeksforgeeks.org/online-csharp-compiler" target="_blank" l="Csharp" class="lang btn btn-default form-control">C#</a>
					<a href="https://ide.geeksforgeeks.org/online-java-compiler" target="_blank" l="Java" class="lang btn btn-default form-control">Java</a>
					<a href="https://ide.geeksforgeeks.org/online-perl-compiler" target="_blank" l="Perl" class="lang btn btn-default form-control">Perl</a>
					<a href="https://ide.geeksforgeeks.org/online-php-compiler" target="_blank" l="Php" class="lang btn btn-default form-control">PHP</a>
										<a href="https://ide.geeksforgeeks.org/online-python3-compiler" target="_blank" l="Python3" class="lang btn btn-default form-control" style="background-color: rgb(57, 181, 74); color: rgb(0, 0, 0);">Python 3</a>
					<a href="https://ide.geeksforgeeks.org/online-scala-compiler" target="_blank" l="Scala" class="lang btn btn-default form-control" style="border-radius: 0;">Scala</a>
					<a href="https://ide.geeksforgeeks.org/online-swift-compiler" target="_blank" l="Swift" class="lang btn btn-default form-control" style="border-radius: 0;">Swift</a>
					<a href="https://ide.geeksforgeeks.org/online-rust-compiler" target="_blank" l="Rust" class="lang btn btn-default form-control" style="border-radius: 0;">Rust</a>
					<a href="https://ide.geeksforgeeks.org/online-golang-compiler" target="_blank" l="Golang" class="lang btn btn-default form-control" style="border-radius: 0;">Golang</a>
					<a href="https://ide.geeksforgeeks.org/online-r-compiler" target="_blank" l="R" class="lang btn btn-default form-control" style="border-radius: 0;">R</a>
					<a href="https://ide.geeksforgeeks.org/online-nodejs-compiler" target="_blank" l="Nodejs" class="lang btn btn-default form-control" style="border-radius: 0;">Node JS</a>
			...
			<div id="codeBlock" class="col-sm-11 col-xs-12" style="padding-left:40px">
				<div class="row">
			                <div class="btn btn-default tab col-sm-2 col-xs-4" style="border-width: 1.5px 1.5px medium; border-style: solid solid none; border-color: rgb(173, 173, 173) rgb(173, 173, 173) currentcolor; background-color: rgb(235, 235, 235);" id="tab0" name="0"> <div class="text">Python 3</div> <button class="btn btn-default btn-sm closeTab" name="0" style="background-color: rgb(235, 235, 235); display: none;"><i class="glyphicon glyphicon-minus-sign"></i></button>  </div><div class="btn btn-default tab col-sm-2 col-xs-4" style="display:none" id="tab1" name="1"> <div class="text">Tab1</div> <button class="btn btn-default btn-sm closeTab" name="1" style="display: none;"><i class="glyphicon glyphicon-minus-sign"></i></button>  </div><div class="btn btn-default tab col-sm-2 col-xs-4" style="display:none" id="tab2" name="2"> <div class="text">Tab2</div> <button class="btn btn-default btn-sm closeTab" name="2" style="display: none;"><i class="glyphicon glyphicon-minus-sign"></i></button>  </div><div class="btn btn-default tab col-sm-2 col-xs-4" style="display:none" id="tab3" name="3"> <div class="text">Tab3</div> <button class="btn btn-default btn-sm closeTab" name="3" style="display: none;"><i class="glyphicon glyphicon-minus-sign"></i></button>  </div><div class="btn btn-default tab col-sm-2 col-xs-4" style="display:none" id="tab4" name="4"> <div class="text">Tab4</div> <button class="btn btn-default btn-sm closeTab" name="4" style="display: none;"><i class="glyphicon glyphicon-minus-sign"></i></button>  </div>	        		        <button class="btn btn-default" id="addTab"><i class="glyphicon glyphicon-plus-sign"></i></button>
					...
					<div class="ideIcons">
						...
						<a id="full" data-toggle="tooltip" title="Fullscreen" href="javascript:void(0)">
							<img src="hard_files/maximize-1673520675.svg">
						</a>
					</div>
	            		</div>
				<div class="row">
					<form role="form" class="dropzone clickable-dz dz-clickable" action=" " enctype="multipart/form-data">
						<div class="form-group">
							<div class="editorBlock" style="height:500px;">
								<pre id="editor" class=" ace_editor ace-chrome" style="font-size: 12pt;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="none" spellcheck="false" style="opacity: 0; font-size: 1px; top: 247px; height: 1px; width: 1px; left: 55px;">

</textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 51px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1000000px; top: 0px; left: 0px; width: 51px;"><div class="ace_gutter-cell " style="height: 19px; top: 0px;">1<span style="display: inline-block; height: 19px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 19px;">2<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 38px;">3<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 57px;">4<span class="ace_fold-widget ace_start ace_open" style="height: 19px; display: inline-block;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 76px;">5<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 95px;">6<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 114px;">7<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 133px;">8<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 152px;">9<span class="ace_fold-widget ace_start ace_open" style="height: 19px; display: inline-block;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 171px;">10<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 190px;">11<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 19px; top: 209px;">12<span style="display: none;"></span></div><div class="ace_gutter-cell ace_gutter-active-line " style="height: 19px; top: 228px;">13<span style="display: none;"></span></div></div></div><div class="ace_scroller" style="left: 50.6px; right: 0px; bottom: 0px;"><div class="ace_content" style="top: 0px; left: 0px; width: 834.4px; height: 536px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 708px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div style="height: 19px; top: 228px; left: 0px; right: 0px;" class="ace_active-line"></div></div><div class="ace_layer ace_text-layer" style="height: 1000000px; margin: 0px 4px; top: 0px; left: 0px;"><div style="height: 19px; top: 0px;" class="ace_line"><span class="ace_keyword">def</span> <span class="ace_identifier">count_digit_one</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">n</span><span class="ace_paren ace_rparen">)</span>:</div><div style="height: 19px; top: 19px;" class="ace_line">    <span class="ace_identifier">count</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_constant ace_numeric">0</span></div><div style="height: 19px; top: 38px;" class="ace_line"></div><div style="height: 19px; top: 57px;" class="ace_line">    <span class="ace_keyword">for</span> <span class="ace_identifier">i</span> <span class="ace_keyword">in</span> <span class="ace_support ace_function">range</span><span class="ace_paren ace_lparen">(</span><span class="ace_constant ace_numeric">1</span>, <span class="ace_identifier">n</span> <span class="ace_keyword ace_operator">+</span> <span class="ace_constant ace_numeric">1</span><span class="ace_paren ace_rparen">)</span>:</div><div style="height: 19px; top: 76px;" class="ace_line"><span class="ace_indent-guide">    </span>    <span class="ace_identifier">count</span> <span class="ace_keyword ace_operator">+=</span> <span class="ace_support ace_function">str</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">i</span><span class="ace_paren ace_rparen">)</span>.<span class="ace_identifier">count</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">'1'</span><span class="ace_paren ace_rparen">)</span></div><div style="height: 19px; top: 95px;" class="ace_line"></div><div style="height: 19px; top: 114px;" class="ace_line">    <span class="ace_keyword">return</span> <span class="ace_identifier">count</span></div><div style="height: 19px; top: 133px;" class="ace_line"></div><div style="height: 19px; top: 152px;" class="ace_line"><span class="ace_comment"># Example usage:</span></div><div style="height: 19px; top: 171px;" class="ace_line"><span class="ace_identifier">n</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_support ace_function">int</span><span class="ace_paren ace_lparen">(</span><span class="ace_support ace_function">input</span><span class="ace_paren ace_lparen">(</span><span class="ace_string">"Enter an integer n: "</span><span class="ace_paren ace_rparen">))</span></div><div style="height: 19px; top: 190px;" class="ace_line"><span class="ace_identifier">result</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_identifier">count_digit_one</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">n</span><span class="ace_paren ace_rparen">)</span></div><div style="height: 19px; top: 209px;" class="ace_line"><span class="ace_keyword">print</span><span class="ace_paren ace_lparen">(</span><span class="ace_identifier">f</span><span class="ace_string">"Total number of digit 1 appearing in numbers up to {n}: {result}"</span><span class="ace_paren ace_rparen">)</span></div><div style="height: 19px; top: 228px;" class="ace_line"></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="animation-duration: 1000ms; display: block; top: 228px; left: 4px; width: 9px; height: 19px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 20px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 247px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 50.6px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 843px;"></div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; font-size-adjust: inherit; font-kerning: inherit; font-optical-sizing: inherit; font-language-override: inherit; font-feature-settings: inherit; font-variation-settings: inherit; overflow: visible;"></div></div></pre>
							</div>
						</div>
					<div class="dz-default dz-message"><span></span></div></form>
				</div>
					...
					<div class="col-sm-offset-1 col-sm-11 col-xs-12 inputRunRow">
						<div class="row inputRunDiv">
							<div id="inputDivClass" class="form-group col-sm-7 col-xs-12 inputDiv">
								<textarea id="input" placeholder="Input Goes Here.." maxlength="10000" class="gb wf form-control input" style="height:200px;">13
</textarea>
								<button class="btn btn-default btnInput" type="button">Copy</button>
							</div>
							<div class="sbt-group col-sm-4 buttonDiv" role="group">
								<button id="run" class="sbt btn btn-default" title="" aria-describedby="ui-id-3"><span class="glyphicon glyphicon-chevron-right"></span> <b>Run</b></button>
				...
				<div class="row">
						<div class="col-sm-11 col-xs-12">
							<div class="lang-group btn-group col-sm-12" role="group">
								<a href="https://ide.geeksforgeeks.org/online-c-compiler" target="_blank" l="C" class="lang btn btn-default" style="border-radius: 0;">C</a>
								<a href="https://ide.geeksforgeeks.org/online-cpp-compiler" target="_blank" data-toggle="tooltip" title="C++11 supported" l="Cpp" class="lang btn btn-default">C++</a>
								<a href="https://ide.geeksforgeeks.org/online-cpp14-compiler" target="_blank" l="Cpp14" class="lang btn btn-default">C++14</a>
								<a href="https://ide.geeksforgeeks.org/online-csharp-compiler" target="_blank" l="Csharp" class="lang btn btn-default">C#</a>
								<a href="https://ide.geeksforgeeks.org/online-java-compiler" target="_blank" l="Java" class="lang btn btn-default">Java</a>
								<a href="https://ide.geeksforgeeks.org/online-perl-compiler" target="_blank" l="Perl" class="lang btn btn-default">Perl</a>
								<a href="https://ide.geeksforgeeks.org/online-php-compiler" target="_blank" l="Php" class="lang btn btn-default">PHP</a>
																<a href="https://ide.geeksforgeeks.org/online-python3-compiler" target="_blank" l="Python3" class="lang btn btn-default" style="background-color: rgb(57, 181, 74); color: rgb(0, 0, 0);">Python 3</a>
								<a href="https://ide.geeksforgeeks.org/online-scala-compiler" target="_blank" l="Scala" class="lang btn btn-default" style="border-radius: 0;">Scala</a>
								<a href="https://ide.geeksforgeeks.org/online-swift-compiler" target="_blank" l="Swift" class="lang btn btn-default form-control" style="border-radius: 0;">Swift</a>
								<a href="https://ide.geeksforgeeks.org/online-rust-compiler" target="_blank" l="Rust" class="lang btn btn-default form-control" style="border-radius: 0;">Rust</a>
								<a href="https://ide.geeksforgeeks.org/online-golang-compiler" target="_blank" l="Golang" class="lang btn btn-default form-control" style="border-radius: 0;">Golang</a>
								<a href="https://ide.geeksforgeeks.org/online-r-compiler" target="_blank" l="R" class="lang btn btn-default form-control" style="border-radius: 0;">R</a>
								<a href="https://ide.geeksforgeeks.org/online-nodejs-compiler" target="_blank" l="Nodejs" class="lang btn btn-default" style="border-radius: 0;">Node JS</a>
...
EOFError: EOF when reading a line
							...
							<pre class="gb wf" id="preOutput">Enter an integer n: </pre>
						</div>
									</div>
				</div>
		...
		<div class="col-sm-3 col-xs-12">
			...
			<div id="div-ide-img" class="imgDiv"><a href="https://practice.geeksforgeeks.org/courses/Python-Foundation?utm_source=ide&amp;utm_medium=course_python_programming&amp;utm_campaign=inbound_promotions" target="_blank" style="position: relative;"><img class="img-responsive" src="hard_files/Python-1672989593.gif"></a></div>
						<br>
					</div>
	</div>
</div>
...
<style>
    ...
    <link rel="stylesheet" href="hard_files/jquery-ui.min.css">
    <script async="" type="text/javascript" src="hard_files/jquery-ui.min.js"></script>
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async="" src="hard_files/js_003"></script>
    <script>
...
<div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"><div style="display: none;">Generates URL as well for Code Sharing</div><div style="display: none;">Run Program(Ctrl+Enter)</div><div style="display: none;">Run Program(Ctrl+Enter)</div><div style="display: none;">Sign in with Google Dialogue</div><div>Sign in with Google Dialogue</div></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><div role="log" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div><input type="file" class="dz-hidden-input" accept=" .cpp , .c , .java , .py , .php , .cs , .scala , .perl " style="visibility: hidden; position: absolute; top: 0px; left: 0px; height: 0px; width: 0px;"><input type="file" class="dz-hidden-input" accept=" .cpp , .c , .java , .py , .php , .cs , .scala , .perl " style="visibility: hidden; position: absolute; top: 0px; left: 0px; height: 0px; width: 0px;"><input type="file" class="dz-hidden-input" accept=" .cpp , .c , .java , .py , .php , .cs , .scala , .perl " style="visibility: hidden; position: absolute; top: 0px; left: 0px; height: 0px; width: 0px;"><iframe style="display: none; width: 0px; height: 0px; border: medium; z-index: -1000; left: -1000px; top: -1000px;" name="googlefcPresent"></iframe><div style="background-color: rgb(255, 255, 255); border: 1px solid rgb(204, 204, 204); box-shadow: rgba(0, 0, 0, 0.2) 2px 2px 3px; position: absolute; transition: visibility 0s linear 0.3s, opacity 0.3s linear 0s; opacity: 0; visibility: hidden; z-index: 2000000000; left: 0px; top: -10000px;"><div style="width: 100%; height: 100%; position: fixed; top: 0px; left: 0px; z-index: 2000000000; background-color: rgb(255, 255, 255); opacity: 0.05;"></div><div style="border: 11px solid transparent; width: 0px; height: 0px; position: absolute; pointer-events: none; margin-top: -11px; z-index: 2000000000;" class="g-recaptcha-bubble-arrow"></div><div style="border: 10px solid transparent; width: 0px; height: 0px; position: absolute; pointer-events: none; margin-top: -10px; z-index: 2000000000;" class="g-recaptcha-bubble-arrow"></div><div style="z-index: 2000000000; position: relative;"><iframe title="recaptcha challenge expires in two minutes" style="width: 100%; height: 100%;" name="c-vz6papwdi3v7" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" src="hard_files/bframe_003.htm"></iframe></div></div><div style="background-color: rgb(255, 255, 255); border: 1px solid rgb(204, 204, 204); box-shadow: rgba(0, 0, 0, 0.2) 2px 2px 3px; position: absolute; transition: visibility 0s linear 0.3s, opacity 0.3s linear 0s; opacity: 0; visibility: hidden; z-index: 2000000000; left: 0px; top: -10000px;"><div style="width: 100%; height: 100%; position: fixed; top: 0px; left: 0px; z-index: 2000000000; background-color: rgb(255, 255, 255); opacity: 0.05;"></div><div style="border: 11px solid transparent; width: 0px; height: 0px; position: absolute; pointer-events: none; margin-top: -11px; z-index: 2000000000;" class="g-recaptcha-bubble-arrow"></div><div style="border: 10px solid transparent; width: 0px; height: 0px; position: absolute; pointer-events: none; margin-top: -10px; z-index: 2000000000;" class="g-recaptcha-bubble-arrow"></div><div style="z-index: 2000000000; position: relative;"><iframe title="recaptcha challenge expires in two minutes" style="width: 100%; height: 100%;" name="c-ur3j0nbu87hn" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" src="hard_files/bframe_003.htm"></iframe></div></div><div style="background-color: rgb(255, 255, 255); border: 1px solid rgb(204, 204, 204); box-shadow: rgba(0, 0, 0, 0.2) 2px 2px 3px; position: absolute; transition: visibility 0s linear 0.3s, opacity 0.3s linear 0s; opacity: 0; visibility: hidden; z-index: 2000000000; left: 0px; top: -10000px;"><div style="width: 100%; height: 100%; position: fixed; top: 0px; left: 0px; z-index: 2000000000; background-color: rgb(255, 255, 255); opacity: 0.05;"></div><div style="border: 11px solid transparent; width: 0px; height: 0px; position: absolute; pointer-events: none; margin-top: -11px; z-index: 2000000000;" class="g-recaptcha-bubble-arrow"></div><div style="border: 10px solid transparent; width: 0px; height: 0px; position: absolute; pointer-events: none; margin-top: -10px; z-index: 2000000000;" class="g-recaptcha-bubble-arrow"></div><div style="z-index: 2000000000; position: relative;"><iframe title="recaptcha challenge expires in two minutes" style="width: 100%; height: 100%;" name="c-54yvbecwjunu" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox allow-storage-access-by-user-activation" src="hard_files/bframe_003.htm"></iframe></div></div><iframe name="__tcfapiLocator" src="hard_files/a.htm" style="display: none; width: 0px; height: 0px; border: medium; z-index: -1000; left: -1000px; top: -1000px;"></iframe><iframe name="__uspapiLocator" src="hard_files/a.htm" style="display: none; width: 0px; height: 0px; border: medium; z-index: -1000; left: -1000px; top: -1000px;"></iframe><iframe name="__gppLocator" src="hard_files/a.htm" style="display: none; width: 0px; height: 0px; border: medium; z-index: -1000; left: -1000px; top: -1000px;"></iframe><iframe name="googlefcInactive" src="hard_files/a.htm" style="display: none; width: 0px; height: 0px; border: medium; z-index: -1000; left: -1000px; top: -1000px;"></iframe><iframe name="googlefcLoaded" src="hard_files/a.htm" style="display: none; width: 0px; height: 0px; border: medium; z-index: -1000; left: -1000px; top: -1000px;"></iframe><script type="text/javascript" src="hard_files/Untitled"></script><script type="text/javascript" src="hard_files/geoip2.js"></script><div role="tooltip" id="ui-id-3" class="ui-tooltip ui-corner-all ui-widget-shadow ui-widget ui-widget-content" style="top: 667px; left: 624.583px; display: block;"><div class="ui-tooltip-content">Run Program(Ctrl+Enter)</div></div><div role="tooltip" id="ui-id-5" class="ui-tooltip ui-corner-all ui-widget-shadow ui-widget ui-widget-content" style="top: 701px; left: 955px; display: block;"><div class="ui-tooltip-content">Sign in with Google Dialogue</div></div></body></html>